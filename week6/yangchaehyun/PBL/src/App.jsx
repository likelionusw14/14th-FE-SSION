...
function App() {
    ...
    <>
        <Body />
        <Footer />
        <div className={styles.grid}>{lionKing.map(lion => <MiniLion id={lion.id} name={lion.name} track={lion.track} summary={lion.summary} img={lion.img}/>)}</div>
        {lionKing.map(lion => <Lion id={lion.id} name={lion.name} skills={lion.skills} summary={lion.summary} description={lion.description} email={lion.email} phone={lion.phone} website={lion.website} oneLiner={lion.oneLiner} img={lion.img}/>)}
    </>
    );
}
export default App