...
import MiniLion from "./components/MiniLion";
import styles from "./components/Lion.module.css";
...
function App() {
    ...
    return (
    <>
        <Body lionData={lionKing} />
        <div className={styles.grid}> {lionKing.map(lion => (<MiniLion key={lion.id} id={lion.id} name={lion.name} track={lion.track} summary={lion.summary} img={lion.img} skills={lion.skills}/>))}</div>
        {lionKing.map(lion => (<Lion key={lion.id} id={lion.id} name={lion.name} skills={lion.skills} summary={lion.summary} description={lion.description} email={lion.email} phone={lion.phone} website={lion.website} oneLiner={lion.oneLiner} img={lion.img}/>))}
    </>
    );
}
export default App